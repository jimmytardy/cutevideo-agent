...
export default function MarketsPage() {
  ...
  return (
    <AdminGuard>
      <PageContainer>
        <PageHeader
          title="Marchés analysés"
          description="Historique des analyses marché réalisées lors de l'onboarding des chaînes."
        />

        {isLoading && <LoadingState count={4} />}
        {error && <ErrorState message="Impossible de charger les analyses" />}
        {!isLoading && !error && analyses?.length === 0 && (
          <EmptyState
            title="Aucune analyse"
            description="Lancez l'onboarding d'une chaîne pour créer une analyse marché."
